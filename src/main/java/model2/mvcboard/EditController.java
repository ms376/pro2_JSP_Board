...
public class EditController extends HttpServlet
{
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        // 인출된 내용은 request영역에 저장한 후 View로 포원드한다.
        req.setAttribute("dto", dto);
        req.getRequestDispatcher("/ms/board/deboard.jsp").forward(req, resp);
    }
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp)
        ...
        // hidden박승에 저장된 내용(게시물 수정 및 파일수정에 필요함.
        ...
        /*
         	패스워드의 경우 인증완료시 session영역에 저장해 둔것을 얻어온다.
         	update쿼리 실행시 where에 조건으로 초가된다.
