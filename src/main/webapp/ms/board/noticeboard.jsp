						...
						<table class="table table-bordered table-striped"
							...
							<thead>
								...
								<tr align="center" class="success">
									...
									<!-- 제목 -->
									<td align="left"><a
										href="noticevboard.jsp?num=<%=dto.getNum()%>"><%=dto.getTitle()%></a>
									</td>
									<!-- 카테고리 -->
									<td>공지사항</td>
									<!-- 글쓴이 -->
				...
				<div class="col-md-12 text-center">
					<form class="form-inline" role="form" method="post">
						...
						<button type="button" class="btn-u btn-u-blue"
							onclick="location.href='noticewboard.jsp'">글쓰기</button>
						<%
						} else {
						%>
						<button class="btn-u btn-blue" onclick="openPopup()">글쓰기</button>
						<%
						}
						%>
						<script>
