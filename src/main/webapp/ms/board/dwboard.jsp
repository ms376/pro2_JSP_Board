				...
				<div class="container">
					...
					<div class="collapse navbar-collapse navbar-responsive-collapse">
						<ul class="nav navbar-nav">
												...
												<div class="row equal-height">
													<div class="col-md-3 equal-height-in">
														<ul class="list-unstyled equal-height-list">
															...
															%>
															<li><a href="../ms/board/adboard.jsp">관리자 게시판</a></li>
															<%
															} else {
															%>
															<li><a href="../ms/board/popup.jsp">관리자 게시판</a></li>
															<%
															}
															%>
														</ul>
							...
							<li><a href="../ms/board/mapb.jsp">지도</a></li>
							<li class="dropdown "><a href="javascript:void(0);"
								class="dropdown-toggle" data-toggle="dropdown">더 보기</a>
								<ul class="dropdown-menu">
									<li><a href="../ms/board/mapb.jsp">위치</a></li>
									<li><a href="#">채팅</a></li>
									<li><a href="#">신고</a></li>
								</ul></li>
						</ul>
			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					<div class="table-responsive">
						<form action="../mvcboard/write.do" name="wirteFrm" method="post"
							...
							<table class="table table-bordered table-striped"
								...
								<tr>
									...
									<td>
										...
										<textarea name="content" id="ir1" rows="10" cols="100"
											style="width: 90%; height: 200px;"></textarea> <script
								...
								<tr>
									<td align="right"><h5>첨부 파일</h5></td>
									<td><input type="file" name="ofile" id="" /></td>
								</tr>
								<tr>
									<td align="right"><h5>비밀번호</h5></td>
								...
								<tr>
									<td colspan="2" align="center">
										...
										<button type="button" class="btn" onclick="location.href='../mvcboard/list.do';">돌아가기</button>
