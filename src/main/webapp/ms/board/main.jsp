			...
			<div class="row">
				<div class="col-md-12">
					<ul class="nav nav-pills">
						<li class="active"><a href="main.jsp">전체게시판</a></li>
						<li><a href="noticeboard.jsp">공지사항</a></li>
						<li><a href="fboard.jsp">자유게시판</a></li>
						<li><a href="../../mvcboard/list.do">자료실</a></li>
					</ul>
					...
					<div class="table-responsive">
						<table class="table table-bordered table-striped"
							...
							<thead>
								<tr>
									<td colspan="10">
									<iframe src="noticeboard_part.jsp" frameborder="0" width="100%"></iframe> 
									<iframe src="fboard_part.jsp" frameborder="0" width="100%" height="300px"></iframe>
									</td>
								</tr>
							</thead>
						</table>
