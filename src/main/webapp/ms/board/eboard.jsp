...
<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<%@ include file="../aboutpost/IsLoggedIn.jsp"%>
<%
	...
	<div class="wrapper">
		...
		<div class="container content">
			...
			<div class="row">
				...
				<form name="writeFrm" method="post" action="../aboutpost/EditProcess.jsp"
		...
		<table class="table table-bordered table-striped"
			...
			<tr>
				<td colspan="2" align="center">
					...
					<button type="button" class="btn" onclick="location.href='../board/main.jsp';">목록보기</button>
				</td>
			</tr>
		</table>
	</form>
