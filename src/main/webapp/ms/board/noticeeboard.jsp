...
<%@ include file="../aboutpost/IsLoggedIn2.jsp"%>
<%
	...
	<div class="wrapper">
			...
			<div class="row">
				<div class="col-md-12">
					<ul class="nav nav-pills">
						...
						<li><a href="fboard.jsp">자유게시판</a></li>
						<li><a href="../../mvcboard/list.do">자료실</a></li>
						<li><a href="hboard.jsp">Hot 게시판</a></li>
						<li><a href="rectop.jsp">top 댓글</a></li>
					</ul>
				</div>
				...
				<div class="col-md-12">
					...
					<form name="writeFrm" method="post" action="../aboutpost/EditProcess2.jsp"
		onsubmit="return validateForm(this);">
		<!-- 
			게시물의 일련번호를 서버로 전송하기 위해서 hidden타입의 
		 -->
		...
		<table class="table table-bordered table-striped"
			...
			<tr>
				...
				<td><input type="text" name="title" style="width: 95%;"value="<%= dto.getTitle() %>" /></td><tr>
				<td align="right"><h5>내용</h5></td>
				<td><textarea name="content" style="width: 95%; height:300px;"><%= dto.getContent() %></textarea></td>
			</tr>
			<tr>
				<td colspan="2" align="center">
					<button type="submit" class="btn">작성완료</button>
					<button type="reset" class="btn">다시 입력</button>
					<button type="button" class="btn" onclick="location.href='../board/noticeboard.jsp';">목록보기</button>
				</td>
			</tr>
		</table>
	</form>
				...
				<div class="col-md-12 margin-bottom-20"><br />
				</div>
