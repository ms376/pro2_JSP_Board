			...
			<div class="topbar">
				...
				<div class="box">
						<div class="card animated fadeIn">
							<form action="../../membership/UpdateServlet.do" method="post">
								<h3 style="text-align: center;">내 정보</h3>
								<div class="form-group">
									<input type="password" class="form-control" name="UserPassword"
										maxlength="20" placeholder="변경할 Password">
								</div>
								<div class="form-group">
									<input type="text" class="form-control" name="UserName"
										maxlength="20" placeholder="변경할 Name">
								</div>
								...
								if (userId == null) {
									...
									String updatedUserPassword = request.getParameter("UserPassword");
									String updatedUserName = request.getParameter("UserName");

									if (updatedUserId != null && updatedUserPassword != null && updatedUserName != null) {
										MemberDAO memberDAO = new MemberDAO(application);

									int chresult = memberDAO.update(updatedUserId, updatedUserPassword, updatedUserName);
